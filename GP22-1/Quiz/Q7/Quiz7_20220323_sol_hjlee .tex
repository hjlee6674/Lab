...
\noindent {\bf 풀이:} 먼저 탁구공에 대한 자유 물체 다이어그램을 그리자.
\begin{figure}[htp]
  \centering
  \begin{tikzpicture}
    \draw node[black,left] at (0,0) {0} ;
    \draw (0,-2) -- (0,2) ;
    \draw [blue,very thick,-latex] (0,0.1) -- (0,1.7) 
    node [left,black] {$bv^2$};
    \draw [blue,very thick,-latex] (0,-0.1) -- (0,-1.7) 
    node [left,black] {$Mg$};
  \end{tikzpicture}
  \caption{자유 물체 다이어그램}
...
\noindent {\bf 풀이} 자동차 바퀴에 대한 자유 물체 다이어 그램은 다음과 같다.
\begin{figure}[htp]
  \centering
  \begin{tikzpicture}
    \draw (-1.5,2.5) node {ABS가 있을 때 :} ;
    \draw (-2.5,0) -- (2.5,0) ;
    \draw (0,-2.5) -- (0,2.5) ;
    \draw [red,very thick,-latex] (0,0.1) -- (0,2) 
    node [left,black] {$N$};

    \draw [blue,very thick,-latex] (-0.1,0) -- (-1.7,0) 
...
\begin{itemize}
  ...
  \begin{figure}
    \begin{tikzpicture}
      ...
      \draw [rotate=60,violet,very thick,-latex] (0.1,0) -- (2.5,0) 
      node [above,black] {$\vec{F_2}$};
...
\noindent {\bf 풀이 :} 토막에 대한 자유 물체 다이어그램은 다음과 같다.

\begin{figure}[h]
  \begin{tikzpicture}
    \draw (-3,0) -- (3,0) ;
    \draw [violet,very thick,-latex] (37:0.1) -- (37:2)
    node [above,black] {$F$};

    \draw [violet,very thick,-latex] (0,0.1) -- (0,1.2);
    \draw [blue,very thick,-latex] (0,1.2) -- (0,2.3)
    node [left,black] {$N$};

    \draw [violet,thick,dashed] (37:2)--(0,1.2);
    \draw [violet,thick,dashed] (37:2)--(1.6,0);

    \draw [violet,very thick,-latex] (0.1,0) -- (1.6,0)
    node [below,black] {$F_x$};

    \draw [blue,very thick,-latex] (0,-0.1) -- (0,-2.3)
    node [left,black] {$F_g$};
